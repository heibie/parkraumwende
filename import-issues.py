...
def main():
    ...
    for issue in issues:
        ...
        row.update({
            ...
            "Preis/Monat":      fields.get("Preis/Monat", "").replace(" €", ""),
            "Preis/Tag":        fields.get("Preis/Tag", "").replace(" €", ""),
            "Preis/Stunde":     fields.get("Preis/Stunde", "").replace(" €", ""),
            "Öffnungszeiten":   fields.get("Öffnungszeiten", ""),
            "Einfahrtshöhe":    fields.get("Einfahrtshöhe", "").replace(" m", ""),
            "URL 1":            fields.get("URL", ""),
            "Straße":           strasse,
            "Hausnummer":       hausnr,
            "PLZ":              plz,
            "Ort":              ort,
